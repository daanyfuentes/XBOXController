    ...
    : IInputDeviceState, IEquatable<XInputDeviceState>, ICloneable
{
        ...
        SlimTrigger leftTrigger, SlimTrigger rightTrigger)
    {
        ...
        _hashCode = isConnected.GetHashCode()+ Buttons.GetHashCode() +
            LeftJoystick.GetHashCode() + RightJoystick.GetHashCode() + LeftTrigger.GetHashCode() + RightTrigger.GetHashCode();
    }
